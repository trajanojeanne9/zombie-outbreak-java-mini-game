...
public class ZombieOutbreak {
    ...
    public static int role(Scanner input) {
        ...
        switch (roleChoice) {
            ...
            case 2:
                System.out.println("---------------------------------------");
                System.out.println("You have chosen the Cowboy class. You are skilled in quick draws and marksmanship.");
                break;
            case 3:
                System.out.println("---------------------------------------");
    ...
    public static int firstAttack(Scanner input) {
        ...
        if (potionUse.equalsIgnoreCase("yes")) {
            ...
            System.out.println("1. Blue Potion (+80 HP)");   // engineer
    ...
    // MEDIC-ONLY: only reachable if role == Medic and lootChoice == mystery syringe
    public static String survivorScenario(Scanner input, int roleChoice,int potionClass, int lootChoice) {
        ...
        System.out.println("---------------------------------------");
        System.out.println("Would you like to give them the syringe, or save it for the fight ahead? (give/save): ");
    ...
    public static void bossFight(Scanner input, int role, int potionClass, int lootChoice, String syringeChoice) {
        ...
        switch (materialChoice) {
            case 1:
                ...
                System.out.println("To wield the Excalibur, you must meet the following conditions:");
                ...
                if (attemptSword.equalsIgnoreCase("yes")) {
                    if (role == 1 && potionClass == 3 && lootChoice == 5) {
                        ...
                        System.out.println("---------------------------------------");
                        System.out.println("You do not meet the conditions to wield the Excalibur.");
                        System.out.println("The Zombie King has defeated you and your party.");
                        System.out.println("Once again, humanity has lost its hope.");
                    }
                } else {
            ...
            case 2:
                ...
                System.out.println("To use the Annihilator, you must meet the following conditions:");
            ...
            case 3:
                ...
                System.out.println("To use the Toxic Device, you must meet the following conditions:");
                ...
                if (attemptDevice.equalsIgnoreCase("yes")) {
                    if (role == 4 && potionClass == 1 && lootChoice == 1) {
                        ...
                        System.out.println("The Toxic Device has defeated the Zombie King!");
                        System.out.println("Congratulations! You have saved humanity!");
                    } else {
                        System.out.println("---------------------------------------");
            ...
            case 4:
                ...
                if (attemptSmoke.equalsIgnoreCase("yes")) {
                    if (role == 5 && potionClass == 5 && lootChoice == 2) {
                        ...
                        System.out.println("---------------------------------------");
                        System.out.println("You do not meet the conditions to use the Poisonous Smoke.");
                        System.out.println("The Zombie King has defeated you and your party.");
                        System.out.println("Once again, humanity has lost its hope.");
                    }
                } else {
                    System.out.println("---------------------------------------");
                    System.out.println("You have chosen not to attempt to use the Poisonous Smoke.");
                    System.out.println("The Zombie King has defeated you and your party.");
                    System.out.println("Once again, humanity has lost its hope.");
                }
                break;
            case 5:
                System.out.println("---------------------------------------");
                System.out.println("You have chosen the Poisonous Syringe.");
                System.out.println("To use the Poisonous Syringe, you must meet the following conditions:");
                System.out.println("1. You must be a Medic class.");
                System.out.println("2. You must have 120 hp.");
                System.out.println("3. You must have the Mystery Syringe, if you gave the Mystery Syringe to other survivor, you will not be able to use it.");
                System.out.println("Would you like to attempt to use the Poisonous Syringe? (yes/no): ");
                ...
                if (attemptSyringe.equalsIgnoreCase("yes")) {
                    if (role == 3 && potionClass == 2 && lootChoice == 3 && syringeChoice == "give") {
                        System.out.println("---------------------------------------");
                        System.out.println("You have successfully used the Poisonous Syringe!");
                        System.out.println("The Poisonous Syringe has defeated the Zombie King!");
                        System.out.println("Congratulations! You have saved humanity!");
                    } else {
                        System.out.println("---------------------------------------");
                        System.out.println("You do not meet the conditions to use the Poisonous Syringe.");
                        System.out.println("The Zombie King has defeated you and your party.");
                        System.out.println("Once again, humanity has lost its hope.");
                    }
                } else {
                    System.out.println("---------------------------------------");
                    System.out.println("You have chosen not to attempt to use the Poisonous Syringe.");
                    System.out.println("The Zombie King has defeated you and your party.");
                    System.out.println("Once again, humanity has lost its hope.");
                }
                break;
